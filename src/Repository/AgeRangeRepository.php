...
/**
 * @extends ServiceEntityRepository<AgeRange>
 *
...
class AgeRangeRepository extends ServiceEntityRepository
{
    ...
    public function add(AgeRange $entity, bool $flush = false): void
    {
    ...
    public function remove(AgeRange $entity, bool $flush = false): void
    {
